...
import g33 from "@/assets/gallery/hc-green-light-myth.jpg";
import g34 from "@/assets/gallery/car-test-ready-checklist.jpg";
import g35 from "@/assets/gallery/hc-cyclists-stay-left-myth.jpg";
import g36 from "@/assets/gallery/hc-pedestrians-myth.jpg";
import g37 from "@/assets/gallery/cyclist-staying-left-roundabout.jpg";
import g38 from "@/assets/gallery/hc-manoeuvre-mistake-myth.jpg";
import g39 from "@/assets/gallery/look-right-dont-forget-forward.jpg";
import g40 from "@/assets/gallery/hc-roundabout-look-right-myth.jpg";
import g41 from "@/assets/gallery/turning-left-check-cyclists.jpg";
import g42 from "@/assets/gallery/roundabout-lane-choice.jpg";
import g43 from "@/assets/gallery/green-light-would-you-go.jpg";
import g44 from "@/assets/gallery/check-last-before-moving-off.jpg";
import g45 from "@/assets/gallery/double-mini-roundabouts.jpg";
import g46 from "@/assets/gallery/road-markings-guide.jpg";
import g47 from "@/assets/gallery/waiting-and-parking-rules.jpg";
import g48 from "@/assets/gallery/hierarchy-of-road-users.jpg";
import g49 from "@/assets/gallery/zebra-crossing-give-way.jpg";
import g50 from "@/assets/gallery/tyre-pressures-matter.jpg";
...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  { src: g33, title: "Myth: Green means always go", category: "tips" },
  { src: g34, title: "Is your car test-ready? (Annex 6)", category: "tips" },
  { src: g35, title: "Myth: Cyclists must always stay left", category: "tips" },
  { src: g36, title: "Myth: Pedestrians only matter once they step out", category: "tips" },
  { src: g37, title: "Why is the cyclist staying left? (Rule 186)", category: "tips" },
  { src: g38, title: "Myth: One mistake means you've failed", category: "tips" },
  { src: g39, title: "Look right… but don't forget forward (Rule 185)", category: "tips" },
  { src: g40, title: "Myth: You only need to look right at a roundabout", category: "tips" },
  { src: g41, title: "Turning left? Check for cyclists first (Rule H3)", category: "tips" },
  { src: g42, title: "Which lane would you choose? (Rules 184–186)", category: "tips" },
  { src: g43, title: "Green light… would you go? (Rule H2)", category: "tips" },
  { src: g44, title: "What do you check last before moving off? (Rule 159)", category: "tips" },
  { src: g45, title: "One junction or two? Double mini-roundabouts (Rule 189)", category: "tips" },
  { src: g46, title: "Do you know your road markings? (Rule H1)", category: "tips" },
  { src: g47, title: "Can you stop here? Waiting & parking (Rule 240)", category: "tips" },
  {
    src: g48,
  ...
  { src: g50, title: "Tyre pressures matter", category: "tips" },
